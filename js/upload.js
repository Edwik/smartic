  ...
  $.extend({
    uploadPreview : function (options) {
      ...
      var settings = $.extend({
        ...
        label_default: "<i class='material-icons'>camera_alt</i>",
        label_selected: "<i class='material-icons'>camera_alt</i>",
        no_label: false
      }, options);
        ...
        if (typeof($(settings.input_field)) !== 'undefined' && $(settings.input_field) !== null) {
          $(settings.input_field).change(function() {
            ...
            if (files.length > 0) {
              ...
              // Clear background
              $(settings.preview_box).css("background-image", "url(http://fdzeta.com/imgcache/524385dz.jpg)");
